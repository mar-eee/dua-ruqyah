#!/usr/bin/env python3
"""Rebuild dua_main_ja.sqlite from the planned Japanese JSON workspace."""
...
def rebuild(source_dir: Path, output: Path):
    ...
    print(f"Japanese SQLite created: {output}")
...
def main():
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=Path,
        default=source_dir.parent / "dua_main_ja_rebuilt.sqlite",
        help="Output path, default: ../dua_main_ja_rebuilt.sqlite",
    )
